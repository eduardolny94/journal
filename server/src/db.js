...
const COLUMN_MIGRATIONS = [
  ...
  { table: 'accounts', column: 'sync_created_at', ddl: 'TEXT' },
  { table: 'accounts', column: 'sync_last_at', ddl: 'TEXT' },
  { table: 'accounts', column: 'sync_login', ddl: 'TEXT' },
  { table: 'accounts', column: 'sync_server', ddl: 'TEXT' },
  { table: 'accounts', column: 'sync_balance', ddl: 'REAL' },
  { table: 'accounts', column: 'sync_equity', ddl: 'REAL' },
  { table: 'accounts', column: 'sync_floating', ddl: 'REAL' },
  { table: 'accounts', column: 'sync_open_positions', ddl: 'INTEGER' },
  { table: 'accounts', column: 'sync_trades_total', ddl: 'INTEGER DEFAULT 0' },
